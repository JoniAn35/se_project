...
VALUES (-1, 'Sarah', 'Williams', 'sarah.williams@gmail.com'),
...
INSERT INTO horse_parents (horse_id, parent_id)
VALUES (-2, -1),   -- Rocky's mother is Wendy
(-3, -1),   -- Bella's mother is Wendy
(-5, -3),   -- Coco's mother is Bella
(-7, -6),   -- Midnight's mother is Grace
(-9, -10),  -- Daisy's father is Spirit
(-10, -1),  -- Spirit's mother is Wendy
